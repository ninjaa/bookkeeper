...
class SimpleTest(TestCase):
    ...
    def assertEqualLedgers(self, actual, expected):
        ...
        for i in range(len(actual)):
            ...
            self.assertEqual(str(a) is not None, True)
    ...
    def test_basic_entries(self):
        ...
        self.assertEqual(str(self.bank) is not None, True)
        self.assertEqual(str(self.book) is not None, True)
    ...
    def test_book_set_basic(self):
        ...
        self.assertEqual(str(ar1) is not None, True)
    ...
    def test_project_book_usage(self):
        ...
        self.assertEqual(str(project_a) is not None, True)
        self.assertEqual(str(project_b) is not None, True)
        ...
        self.assertEqual(str(party1) is not None, True)
        self.assertEqual(str(arA_party1) is not None, True)
        self.assertEqual(str(arB_party1) is not None, True)
